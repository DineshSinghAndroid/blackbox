                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Obx(() {
                          return Center(
                            child: Text("${progress.value}%",style: TextStyle(color: Colors.blueAccent , fontWeight:FontWeight.bold , fontSize: 16 ),),
                          );
                        }),
                        SizedBox(height: 16,),

                        Text('${text}',style: TextStyle(color: Colors.blueAccent , fontWeight:FontWeight.bold , fontSize: 16 ),),
                      ],
                    ),
                  ),
                ),
